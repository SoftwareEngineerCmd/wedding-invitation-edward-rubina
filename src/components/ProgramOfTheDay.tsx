...
import Photo1Mobile from "../assets/wedding/photo-33.mobile.jpg";
        ...
        <div className=" flex sm:hidden items-center justify-center pb-20">
          <div className="relative w-full max-w-6xl h-[100vw] py-2 flex items-center justify-center">
            ...
            <motion.div
              ...
              className="absolute z-20 w-[50vw] h-[80vw] right-[55%]"
            >
              <img
                src={Photo1Mobile}
                alt="Edward & Rubina"
                className="w-full h-full object-cover object-[27%_50%]"
              />
            </motion.div>
            ...
            <motion.div
              ...
              className="absolute z-10 w-[60vw] h-[90vw] -right-6"
            >
              <img
                src={Photo2}
                alt="Edward & Rubina"
